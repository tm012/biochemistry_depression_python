...
mental_health_data_all <-merge(mental_health_data_1,mental_health_data_2)

mental_health_data_all <-merge(mental_health_data_all,mental_health_data_3)
mental_health_data_all <-merge(mental_health_data_all,mental_health_data_4)
mental_health_data_all <- mental_health_data_all %>% drop_na()
